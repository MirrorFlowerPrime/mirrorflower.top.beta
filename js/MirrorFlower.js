console.log("我是PC端js");
let song_audio_button = document.getElementById("song-audio-button");
window.onload = function () {
  var oAudio = document.getElementById("myaudio");
  song_audio_button.onclick = function () {
  ...
  var color1 = ctx.createLinearGradient(
    oW / 2,
    oH / 2 - 30,
    oW / 2,
    oH / 2 - 100
  );
  var color2 = ctx.createLinearGradient(
    oW / 2,
    oH / 2 + 30,
    oW / 2,
    oH / 2 + 100
  ...
  function draw() {
    ...
    for (var i = 0; i < count; i++) {
      ...
      ctx.fillRect(oW / 2 + i * 5, oH / 2, 3, -audioHeight);
      ctx.fillRect(oW / 2 - i * 5, oH / 2, 3, -audioHeight);
  ...
  /*
    ...
    */
              ...
              if (top != window) {top.postMessage('loaded', 'https://huhuiyu.top/flash.html?targetUrl=https%3A%2F%2Fmirrorflower.top%2F&loadingTime=2&loadingTitle=&loadingInfo=Loading...');}
